...
public class UpdateUserCreditsFork implements Callable<String> {
	...
	public UpdateUserCreditsFork(EventResultDetails eventResultsDetails, RunDetails runDetailsObj, RunSummary existingRunSummary, int size,
	...
	private void updateCredits( RunDetails runDetailsObj, RunSummary runSummary, 
			int size, EventResultDetails eventResultDetailsObj) {
